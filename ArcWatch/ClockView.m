...
#define HOURS_HAND_LENGTH 0.7
#define MIN_HAND_LENGTH 0.7
#define SEC_HAND_LENGTH 1
//in pixels
#define HOURS_HAND_WIDTH 30
#define MIN_HAND_WIDTH 13
#define SEC_HAND_WIDTH 8
...
- (void) layoutSubviews
{
	...
	CGPoint cH = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
    CGPoint cM = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
    CGPoint cS = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
    hourHand.position = cH;
    minHand.position = cM;
    secHand.position = cS;
...
//		h = CGImageGetHeight((__bridge CGImageRef)secHand.contents)/scale;
	...
	hourHand.anchorPoint = CGPointMake(0.5,0.11);
	minHand.anchorPoint = CGPointMake(0.5,0.07);
